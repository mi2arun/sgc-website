...
export async function POST() {
  try {
    ...
    await payload.updateGlobal({
      ...
      data: {
        items: [
          ...
          { label: 'Academics', link: '/academics', children: [
          ...
          { label: 'Admissions', link: '/admissions', children: [
          ...
          { label: 'Research', link: '/research', children: [
          ...
          { label: 'Campus Life', link: '/campus-life', children: [
            { label: 'Amenities', link: '/campus-life/amenities' },
          ]},
          { label: 'Student Support', link: '/student-support', children: [
          ...
          { label: 'Accreditation', link: '/accreditation', children: [
          ...
          { label: 'Examination', link: '/examination', children: [
          ...
          { label: 'Placements', link: '/placements', children: [
    ...
    const { docs: existingHome } = await payload.find({
      collection: 'pages', where: { slug: { equals: 'home' } }, limit: 1,
    })

    const homeLayout = [
      { blockType: 'flash-news', items: [
      ...
      { blockType: 'promo-banner', banners: [
      ...
      { blockType: 'programmes', title: 'Academic Excellence Across Disciplines',
      ...
      { blockType: 'scholarship', title: 'Scholarships & Financial Aid',
        ...
        ctaLabel: 'View All Scholarships', ctaLink: '/admissions/scholarships',
      },
      { blockType: 'announcements', title: 'Announcements & Notices', items: [
      ...
      { blockType: 'news-events', title: 'Latest News & Events',
        events: [
        ...
        news: [
          { title: 'SGC Awarded NAAC A+ Grade', date: '2026-03-20', excerpt: 'Saradha Gangadharan College has been awarded A+ grade by NAAC.' },
          ...
          { title: 'Faculty Publication in International Journal', date: '2026-03-15', excerpt: 'Dr. Ramesh Kumar published a paper in IEEE Transactions.' },
          { title: 'Blood Donation Camp Organized', date: '2026-03-12', excerpt: 'Red Cross Youth Club organized a blood donation camp with over 200 donors.' },
        ],
      },
      { blockType: 'activity-feed', items: [
        { title: 'Workshop on AI & Machine Learning', date: '2026-03-29', type: 'Workshop', department: 'Computer Science', description: 'Two-day workshop in collaboration with IIT Madras.' },
        { title: 'Inter-College Basketball Tournament — Champions!', date: '2026-03-27', type: 'Sports', department: 'Physical Education', description: 'SGC Men\'s Basketball team won the Pondicherry University Championship.' },
        { title: 'Guest Lecture: Digital Marketing Trends', date: '2026-03-25', type: 'Seminar', department: 'Commerce', description: 'Mr. Rajesh Kumar, CMO of Zoho Corp, delivered a guest lecture.' },
        { title: 'NSS Blood Donation Camp — 200+ Donors', date: '2026-03-23', type: 'Service', department: 'NSS', description: 'Red Cross Youth Club organized a mega blood donation camp.' },
        { title: 'MoU Signing with Infosys Springboard', date: '2026-03-21', type: 'Collaboration', department: 'Placement Cell', description: 'SGC signed an MoU for industry-ready certification programs.' },
      ]},
      { blockType: 'why-join', title: 'Why Choose SGC?', reasons: [
        ...
        { icon: 'Building', heading: 'Modern Campus', description: 'State-of-the-art infrastructure.' },
        { icon: 'Heart', heading: 'Holistic Development', description: 'NCC, NSS, sports, clubs, and cultural activities.' },
      ]},
      ...
      { blockType: 'testimonials', title: 'What Our Students Say', items: [
        { name: 'Priya Sharma', batch: '2020-2023', quote: 'SGC provided me with the perfect launchpad for my career.' },
        { name: 'Rahul Kumar', batch: '2019-2022', quote: 'The holistic approach to education at SGC helped me grow as a well-rounded individual.' },
        { name: 'Anita Devi', batch: '2021-2024', quote: 'From day one, the professors went above and beyond to ensure we understood concepts thoroughly.' },
      ]},
      { blockType: 'compliance-links', title: 'Important Links & Compliance', links: [
      ...
      { blockType: 'cta', heading: 'Ready to Begin Your Journey?',
        description: 'Join thousands of successful alumni who started their career at SGC.',
        buttonLabel: 'Apply Now', buttonLink: '/admissions/apply', phone: '+91-413-2211800',
      },
    ]

    if (existingHome.length > 0) {
      await payload.update({ collection: 'pages', id: existingHome[0].id, data: { title: 'Home', slug: 'home', status: 'published', layout: homeLayout } as any })
    } else {
      await payload.create({ collection: 'pages', data: { title: 'Home', slug: 'home', status: 'published', layout: homeLayout } as any })
    }
